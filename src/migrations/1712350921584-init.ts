...
export class init1712350921584 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "order_line" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "quantity" integer NOT NULL, "orderPlacedQuantity" integer NOT NULL DEFAULT '0', "listPriceIncludesTax" boolean NOT NULL, "adjustments" text NOT NULL, "taxLines" text NOT NULL, "id" SERIAL NOT NULL, "sellerChannelId" integer, "shippingLineId" integer, "productVariantId" integer NOT NULL, "initialListPrice" integer, "listPrice" integer NOT NULL, "taxCategoryId" integer, "featuredAssetId" integer, "orderId" integer, "customFieldsMaterialid" integer, "customFields__fix_relational_custom_fields__" boolean, CONSTRAINT "PK_01a7c973d9f30479647e44f9892" PRIMARY KEY ("id")); COMMENT ON COLUMN "order_line"."customFields__fix_relational_custom_fields__" IS 'A work-around needed when only relational custom fields are defined on an entity'`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "order_line" ADD CONSTRAINT "FK_a284b709e255a31008faa0ffb17" FOREIGN KEY ("customFieldsMaterialid") REFERENCES "product_variant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "order_line" DROP CONSTRAINT "FK_a284b709e255a31008faa0ffb17"`, undefined);
